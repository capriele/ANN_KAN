...
# Fare tutto con le KAN

# Change state size (Just KAN-Koopman)
...
# Change alpha (0 => KAN-Koopman, 1 => KAN-QLPV)
...
# Change alpha (0 => KAN-Koopman, 1 => KAN-QLPV)
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.0"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.1"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.2"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.3"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.4"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.5"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.6"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.7"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.8"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 0.9"
sbatch --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run_mixed.sh AUV_DATASET "7 8 1 6 15 1 0 0 5 1.0"