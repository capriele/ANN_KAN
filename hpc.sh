...
##        Classical ANN        ##
#################################
submit_and_wait --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run.sh NLTankNLF5Affine "5 1 1 6 10 1 0 0"
...
#################################
submit_and_wait --partition=gprod_gssi -N 1 --ntasks=1 --cpus-per-task=64 --mem=120GB hpc_cluster_run.sh NLTankNLF5Affine "5 1 1 6 10 1 0 0 1"
